...
function Category({ name, testsInfo, inject }) {
	...
	const categoryStyle = "w-1/4 flex flex-col justify-center text-center border-2 border-zinc-300 hover:bg-gray-600 hover:scale-105 hover:shadow-lg transition-transform duration-200"
